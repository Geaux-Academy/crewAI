...
from src.education_crewai.tools.downloader_tool import download_and_store_in_blob
...
downloader = Agent(
    ...
    goal="Visit each URL provided, download the curriculum, process it with OpenAI, and store it in Vercel Blob by subject and grade level.",
    verbose=True,
    memory=True,
    backstory=(
    ...
    tools=[download_and_store_in_blob],  # Use Vercel Blob storage
)
